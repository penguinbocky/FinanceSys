...
public class DepositPanel extends JPanel implements WillBeInMainTabbed{
	...
	private JScrollPane createMiddlePanel() {
		...
		final String[] COL_NAMES = {"ID", "类型 ID", "类型", "来源", "数量", "备注", "发生时间", "最后更新于", "创建时间", "Has_History"};
	...
	private JPanel createBottomPanel() {
		...
		calBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(DepositPanel.this, NumberFormat.getNumberInstance().format(NumberUtil.sumAmount(datagrid)), "(选中/全部)账目总和", JOptionPane.INFORMATION_MESSAGE);
			}
		});
